...
class ProjectsHelperTest < ActionView::TestCase
  test "pagination_info returns correct pagination text" do
  ...
  test "pagination_info returns empty string for empty collection" do
    collection = OpenStruct.new(
      total_pages: 0,
      total_entries: 0
    )
  ...
  test "project_status_color returns correct color class" do
  ...
  test "project_status_icon returns correct SVG path" do
  ...
  test "projects_summary_text returns correct pluralization" do
  ...
  test "projects_completed_text returns correct pluralization" do
  ...
  test "project_delivery_status returns correct status" do
  ...
  test "project_status_badge_html returns HTML with correct classes" do
