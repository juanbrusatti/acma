...
class ScrapsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update scrap" do
    patch scrap_url(@scrap), params: { scrap: { height: @scrap.height, output_work: @scrap.output_work, ref_number: @scrap.ref_number, scrap_type: @scrap.scrap_type, status: @scrap.status, thickness: @scrap.thickness, width: @scrap.width } }
