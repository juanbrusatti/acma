...
Rails.application.configure do
  ...
  # config.assume_ssl = true  # Comentado temporalmente para debugging

  # Force all access to the app over SSL, use Strict-Transport-Security, and use secure cookies.
  # config.force_ssl = true  # Comentado temporalmente para debugging
  ...
  config.hosts = [
    ...
    "192.168.0.143",      # Allow requests from previous server IP
    "192.168.0.150",      # Allow requests from current server IP
