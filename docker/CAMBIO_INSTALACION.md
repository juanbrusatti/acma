# 📋 INSTRUCCIONES PARA CAMBIAR LA INSTALACION
...
2. Desinstalar ACMA
3. Descargar Postgres 17 y configurarlo
4. Eliminar las tareas definidas en el programador de tareas
5. Borrar la carpeta Docker y la reemplazo por la nueva
6. Borrar las imagenes de Docker. Ver si se prende el Docker cada vez que se prende la compu
...
11. Pruebo que funcione todo (tareas, backup, restore, programas, ejecutables, etc)
12. Cobro la bishusha
